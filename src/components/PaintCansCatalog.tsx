                  ...
                  <div className="pt-4 border-t border-slate-200">
                    ...
                    <div className="grid grid-cols-2 gap-2">
                      <button
                        ...
                        className="py-2.5 px-2.5 text-xs font-semibold text-slate-700 bg-slate-100 hover:bg-slate-200 rounded-xl transition-colors flex items-center justify-center gap-1 text-center"
                      >
                      ...
                      <button
                        ...
                        className="py-2.5 px-2.5 text-xs font-bold text-white bg-blue-600 hover:bg-blue-700 rounded-xl shadow-xs transition-colors flex items-center justify-center gap-1 text-center"
                      >
                        <span>Cotizar</span>
